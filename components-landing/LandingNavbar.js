            ...
            <div className="w-90p h-full flex justify-between items-center text-black dark:text-white">
              <div className="flex w-50p gap-20 items-center">
                <h2
                  ...
                  className="max-lg:text-sm max-xl:text-xl h-[100%] flex items-center text-3xl font-bold font-poppins  gap-3 cursor-pointer"
                >
                  <Image src="/fyp2.jpg" height={30} width={50} />
                  Screenify.ai
                </h2>
