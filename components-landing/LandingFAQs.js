          ...
          <div className="w-[50%] h-[70%] mt-[1rem] max-md:w-[90%]">
            <ul className="w-[100%] ">
              ...
              >
                ...
                {dropDownState && (
                  <p className="text-sm  text-smallText mt-3">
                    Screenify is a advance screening platform that connects
              ...
              >
                ...
                {secondDropDownState && (
                  <p className="text-sm  text-smallText mt-3">
                    Our free trial allows you to experience Screenify's
              ...
              >
                ...
                {fourthDropDownState && (
                  <p className="text-sm  text-smallText mt-3">
                    Screenify stands out by combining advanced AI technology
              ...
              >
                <div className=" w-[100%] flex justify-between">
                  <span className="text-lg tracking-wide font-semibold font-sans">
                    How does Screenify help you find the best candidate?
                  </span>
                  {/* <Image
                    onClick={toggleFifthDropDown}
                    src="/dropdown-white.svg"
                ...
                {fifthDropDownState && (
                  <p className="text-sm  text-smallText mt-3">
                    Screenify uses advanced AI to match your specific
